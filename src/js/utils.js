...
var utils = {
	...
	lexIndex: function(obj){
	    var children = utils.lexChildren( obj.parentNode );
	...
	getByParent: function(obj, tagname, classname){
	    var re = new RegExp('(^|\\s)' + classname + '(\\s|$)');
